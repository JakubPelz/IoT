...
const arrayItems_schema_1 = require("./schemas/arrayItems.schema");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: 'Item', schema: item_schema_1.TemperatureSchema },
                { name: 'ArrayItems', schema: arrayItems_schema_1.ArrayItemsSchema },
            ]),
        ],
